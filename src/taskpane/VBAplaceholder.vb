               ...
               ' Define non-green rows
                ...
                If CodeItem.NonGreenStart <= CodeItem.RowEnd Then
                    For L = CodeItem.NonGreenStart To CodeItem.RowEnd
                        ...
                        columnLabels = columnLabels & .Cells(L, "B").value & "|"
                        
                        
                        rowarray = .Cells(L, "A").value
                        rowarray = rowarray & "|" & .Cells(L, "B").value
                        rowarray = rowarray & "|" & .Cells(L, "C").value
                        ...
                        If .Cells(L, "G").formula <> "" Then
                            If Left(.Cells(L, "G").formula, 1) = "=" Then
                                rowarray = rowarray & "|F"
                            Else
                                rowarray = rowarray & "|" & .Cells(L, "G").value
                            End If
                        Else
                            rowarray = rowarray & "|"
                        End If
                        ...
                        If .Cells(L, "H").formula <> "" Then
                            If Left(.Cells(L, "H").formula, 1) = "=" Then
                                rowarray = rowarray & "|F"
                            Else
                                rowarray = rowarray & "|" & .Cells(L, "H").value
                            End If
                        Else
                            rowarray = rowarray & "|"
                        End If
                        ...
                        If .Cells(L, "I").formula <> "" Then
                            If Left(.Cells(L, "I").formula, 1) = "=" Then
                                rowarray = rowarray & "|F"
                            Else
                                rowarray = rowarray & "|" & .Cells(L, "I").value
                            End If
                        Else
                            rowarray = rowarray & "|"
                        End If
                        ...
                        If .Cells(L, "K").formula <> "" Then
                            If Left(.Cells(L, "K").formula, 1) = "=" Then
                                rowarray = rowarray & "|F"
                            Else
                                rowarray = rowarray & "|" & .Cells(L, "K").value
                            End If
                        Else
                            rowarray = rowarray & "|"
                        End If
                        ...
                        If .Cells(L, "L").formula <> "" Then
                            If Left(.Cells(L, "L").formula, 1) = "=" Then
                                rowarray = rowarray & "|F"
                            Else
                                rowarray = rowarray & "|" & .Cells(L, "L").value
                            End If
                        Else
                            rowarray = rowarray & "|"
                        End If
                        ...
                        If .Cells(L, "M").formula <> "" Then
                            If Left(.Cells(L, "M").formula, 1) = "=" Then
                                rowarray = rowarray & "|F"
                            Else
                                rowarray = rowarray & "|" & .Cells(L, "M").value
                            End If
                        Else
                            rowarray = rowarray & "|"
                        End If
                        ...
                        If .Cells(L, "N").formula <> "" Then
                            If Left(.Cells(L, "N").formula, 1) = "=" Then
                                rowarray = rowarray & "|F"
                            Else
                                rowarray = rowarray & "|" & .Cells(L, "N").value
                            End If
                        Else
                            rowarray = rowarray & "|"
                        End If
                        ...
                        If .Cells(L, "O").formula <> "" Then
                            If Left(.Cells(L, "O").formula, 1) = "=" Then
                                rowarray = rowarray & "|F"
                            Else
                                rowarray = rowarray & "|" & .Cells(L, "O").value
                            End If
                        Else
                            rowarray = rowarray & "|"
                        End If
                        ...
                        If .Cells(L, "P").formula <> "" Then
                            If Left(.Cells(L, "P").formula, 1) = "=" Then
                                rowarray = rowarray & "|F"
                            Else
                                rowarray = rowarray & "|" & .Cells(L, "P").value
                            End If
                        Else
                            rowarray = rowarray & "|"
                        End If
                        ...
                        If .Cells(L, "R").formula <> "" Then
                            If Left(.Cells(L, "R").formula, 1) = "=" Then
                                rowarray = rowarray & "|F"
                            Else
                                rowarray = rowarray & "|" & .Cells(L, "R").value
                            End If
                        Else
                            rowarray = rowarray & "|"
                        End If
